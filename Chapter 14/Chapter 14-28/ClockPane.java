...
import javax.xml.soap.*;
     ...
     private boolean minutesVisible = true;
    ...
    public void setSecond(int second) {
     ...
     public void setCurrentTime() {
       ...
       this.hour = (int)(Math.random() * 60);
       this.minute = (int)(Math.random() * 60);
     ...
     protected void paintClock() {
      ...
      double xMinute = centerX + mLength * //Math.random(60);
